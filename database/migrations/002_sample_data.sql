...
INSERT INTO gas_stations (id, name, brand, address, city, state, postal_code, location, phone, amenities, data_source, data_confidence) VALUES
('11111111-1111-1111-1111-111111111111', 'Posto Shell Paulista', 'Shell', 'Av. Paulista, 1500, Bela Vista', 'São Paulo', 'SP', '01310-100', ST_GeomFromText('POINT(-46.6565 -23.5618)', 4326), '+551133334444', '["convenience_store", "restroom", "atm", "car_wash"]', 'manual', 0.9),
('22222222-2222-2222-2222-222222222222', 'Posto Petrobras Faria Lima', 'Petrobras', 'Av. Faria Lima, 2000, Itaim Bibi', 'São Paulo', 'SP', '01451-000', ST_GeomFromText('POINT(-46.6937 -23.5707)', 4326), '+551144445555', '["convenience_store", "car_wash", "tire_service"]', 'manual', 0.9),
('33333333-3333-3333-3333-333333333333', 'Posto Ipiranga Vila Olímpia', 'Ipiranga', 'Rua Funchal, 500, Vila Olímpia', 'São Paulo', 'SP', '04551-060', ST_GeomFromText('POINT(-46.6890 -23.5955)', 4326), '+551155556666', '["convenience_store", "restroom", "atm"]', 'manual', 0.9),
('44444444-4444-4444-4444-444444444444', 'Posto BR Marginal', 'BR', 'Marginal Tietê, 1000, Barra Funda', 'São Paulo', 'SP', '01140-000', ST_GeomFromText('POINT(-46.6600 -23.5200)', 4326), '+551166667777', '["convenience_store", "restaurant", "truck_stop"]', 'manual', 0.8),
('55555555-5555-5555-5555-555555555555', 'Posto Ale Ibirapuera', 'Ale', 'Av. Ibirapuera, 2000, Ibirapuera', 'São Paulo', 'SP', '04029-200', ST_GeomFromText('POINT(-46.6577 -23.5875)', 4326), '+551177778888', '["convenience_store", "car_wash"]', 'manual', 0.8),
('66666666-6666-6666-6666-666666666666', 'Posto Shell Berrini', 'Shell', 'Av. Eng. Luís Carlos Berrini, 1000, Brooklin', 'São Paulo', 'SP', '04571-010', ST_GeomFromText('POINT(-46.6947 -23.6108)', 4326), '+551188889999', '["convenience_store", "restroom", "atm", "electric_charging"]', 'manual', 0.9),
('77777777-7777-7777-7777-777777777777', 'Posto Petrobras Anhangabaú', 'Petrobras', 'Vale do Anhangabaú, 100, Centro', 'São Paulo', 'SP', '01013-000', ST_GeomFromText('POINT(-46.6388 -23.5489)', 4326), '+551199990000', '["convenience_store", "restroom"]', 'manual', 0.7),
('88888888-8888-8888-8888-888888888888', 'Posto Ipiranga Morumbi', 'Ipiranga', 'Av. Giovanni Gronchi, 5000, Morumbi', 'São Paulo', 'SP', '05724-002', ST_GeomFromText('POINT(-46.7284 -23.6178)', 4326), '+551100001111', '["convenience_store", "car_wash", "tire_service", "oil_change"]', 'manual', 0.8),
('99999999-9999-9999-9999-999999999999', 'Posto BR Interlagos', 'BR', 'Av. Interlagos, 3000, Interlagos', 'São Paulo', 'SP', '04661-100', ST_GeomFromText('POINT(-46.6759 -23.6801)', 4326), '+551111112222', '["convenience_store", "restaurant", "atm"]', 'manual', 0.8),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Posto Shell Santana', 'Shell', 'Av. Cruzeiro do Sul, 1500, Santana', 'São Paulo', 'SP', '02030-100', ST_GeomFromText('POINT(-46.6289 -23.5089)', 4326), '+551122223333', '["convenience_store", "restroom", "car_wash"]', 'manual', 0.9);
