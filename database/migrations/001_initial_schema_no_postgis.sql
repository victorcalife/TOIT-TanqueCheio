-- Migration: 001_initial_schema_no_postgis.sql
-- Description: Initial database schema for Tanque Cheio application (without PostGIS)
-- Created: 2025-08-21
...
-- Location indexes (using btree for lat/lng)
CREATE INDEX idx_gas_stations_location ON gas_stations(latitude, longitude);
CREATE INDEX idx_gps_tracking_location ON gps_tracking(latitude, longitude);
CREATE INDEX idx_notifications_user_location ON notifications(user_latitude, user_longitude);
